...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (qs('btnGenPerm')) {
        qs('btnGenPerm').addEventListener('click', () => {
            ...
            const guarantorPart = guarID ? `Поручителем выступил игрок [b][cat${guarID}] [${guarID}].[/b] За все ваши действия этот игрок несёт ответственность.[br][br]` : "";
